...
export class Migration20220717105730 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create index "notification_user_id_type_actor_id_target_id_index" on "notification" ("user_id", "type", "actor_id", "target_id");');
    this.addSql('create index "notification_user_id_type_target_id_read_index" on "notification" ("user_id", "type", "target_id", "read");');
